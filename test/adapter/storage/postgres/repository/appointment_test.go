...
func TestGetAppointmentByIDIntegration(t *testing.T) {
	testContainer := helpers.SetupTestDB(t)
	defer testContainer.Teardown()
	...
	slotID := uuid.New()
	_, err = db.Exec(ctx,
		`INSERT INTO "Appointment" (id, "adminId", "startTime", "endTime", "isBooked") 
		VALUES ($1, $2, $3, $4, $5)`,
	...
	retrievedSlot, err := repo.GetAppointmentByID(ctx, slotID)
	if err != nil {
