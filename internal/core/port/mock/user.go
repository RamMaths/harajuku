...
import (
	...
	domain "harajuku/backend/internal/core/domain"
...
func (mr *MockUserRepositoryMockRecorder) ListUsers(ctx, skip, limit any, filters domain.UserFilters) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListUsers", reflect.TypeOf((*MockUserRepository)(nil).ListUsers), ctx, skip, limit, filters)
}
